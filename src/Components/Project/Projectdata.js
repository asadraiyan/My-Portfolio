export const Projectdata = [
    {
        ...
        description: "Created an E-Commerce app using React.Js. It is an e-commerce app that allows customers to purchase goods and services online. In this app there are different types of products that one can purchase such as men's and women's clothing , jewellery and electronics products. You can see it working here:",
    ...
    },
    {
        ...
        name: "Weather App",
        date: "6th March, 2023",
        description: "Created an app using React.Js. A real time weather app which shows current weather of a particular city in the world, it also shows different weather properties like pressure, wind, humidity etc. You can see it working here:",
    ...
    },
    {
        ...
        description: "Created an app using React.Js. A stopwatch is a watch with buttons which you press at the beginning and end of an event, so that you can measure exactly how long it takes. You can see it working here:",
...

    {
        ...
        description: "Created an app using HTML CSS & Javascript. In this Calculator app, we can perform basic operations like addition, multiplication, subtraction, and division. You can see it working here.:",
